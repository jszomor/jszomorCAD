    ...
    {   
      ...
      var insertLIT = new InsertBlockBase(
        ...
        * PositionProperty.DistanceOfPump + 50,   //X
        ...
        "Equalization Tank",                      //Host name       
        0);                                       //pipe length
        insertBlockTable.InsertBlockTableMethod(db, insertLIT);
      //
      var insertFIT = new InsertBlockBase(
       ...
       "Equalization Tank",                       //Host name       
        0);                                       //pipe length
      insertBlockTable.InsertBlockTableMethod(db, insertFIT);
      //
      var insertJetPump = new InsertBlockBase(
        ...
        "Equalization Tank",                      //Host name       
        0);                                       //pipe length
      insertBlockTable.InsertBlockTableMethod(db, insertJetPump);
      //
      var insertChannelGateSTB = new InsertBlockBase(
       ...
       "Equalization Tank",                       //Host name       
        0);                                       //pipe length
      insertBlockTable.InsertBlockTableMethod(db, insertChannelGateSTB);
      //
      var insertChannelGateDTY = new InsertBlockBase(
        ...
        "Equalization Tank",                       //Host name       
        0);                                        //pipe length
      insertBlockTable.InsertBlockTableMethod(db, insertChannelGateDTY);
      //
      ...
      var insertPipe1 = new InsertBlockBase(
        ...
        "Equalization Tank",                       //Host name       
        36);                                       //pipe length
      insertBlockTable.InsertBlockTableMethod(db, insertPipe1);
      //
