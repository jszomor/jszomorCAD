...
namespace jCAD.PID_Builder
{
	public static class Wrappers
	{
		...
		public static void ExecuteActionInTransaction(Database db, Action<Database, Transaction> action)
		{
		...
		private static void ExecuteActionOnTable<T>(Database db,
		...
		public static void ExecuteActionOnBlockTable(Database db, Action<BlockTable> action) =>
			ExecuteActionOnTable(db, x => x.BlockTableId, action);

		public static void ExecuteActionOnLayerTable(Database db, Action<LayerTable> action) =>
		...
		public static bool AlreadyHasAttributeDefined(this BlockTableRecord btr, string attributeTag)
		{
